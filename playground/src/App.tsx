...
export const App = () => {
  ...
  const onClickCommandExample = ($event: any) => {
    setCopied(() => true)
  ...
  return (
    <div className="App">
      ...
      <div className="Header flex flex-col items-center">
        ...
        <div className="Header__install">
          ...
          >
            ...
            >command copied to clipboard</div>}
            <div
              onClick={($event) => onClickCommandExample($event)}
            ...
            <div className="dark:bg-gray-900 bg-white rounded w-full">
              <div className="flex h-full flex-col">
                ...
                <div className="text-xs mt-2 dark:text-white text-gray-800">
                  Here the result where is rendered the text in red according with the <code>class-a</code> when is true.
                </div>
              </div>
          ...
          <div className="flex w-full">
            <div className="dark:bg-gray-900 bg-white rounded w-full">
              <div className="flex h-full flex-col">
                ...
                <div className="text-xs mt-2 dark:text-white text-gray-800">
                  Here the result where is rendered the text in red according with the <code>class-b</code> when is true.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex w-full">
            <div className="dark:bg-gray-900 bg-white rounded w-full">
              <div className="flex h-full flex-col">
                ...
                <div className="text-xs mt-2 dark:text-white text-gray-800">
                  Here the result where is rendered the text in red according with the <code>class-a</code> and <code>class-c</code> when is true.
                </div>
              </div>
            </div>
          </div>
      ...
      <div className={false ? "bg-red-500" : ""}>
        hollaaaaa
      </div>

      <footer className="relative mt-4 p-8 text-xs dark:text-white text-gray-800">
        Made with ♥ from Barcelona by <a href="https://twitter.com/dimaslz" className="text-blue-500 hover:text-blue-400">@dimaslz</a> to the <span className="text-blue-300 font-semibold">React</span> community | { new Date().getFullYear() }
      </footer>
    </div>
  );
}
